...
public class SendMailTLS {
	...
	public static void test() {
		...
		sender.send("maximo@maxsoft.com", "maximovs@gmail.com", "1", "Si viste?");
		sender.send("maximo@maxsoft.com", "maximovs@gmail.com", "2", "Si viste?");
		sender.send("maximo@maxsoft.com", "maximovs@gmail.com", "3", "Si viste?");
		sender.Stop();
