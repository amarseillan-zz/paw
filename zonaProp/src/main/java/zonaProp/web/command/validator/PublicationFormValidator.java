...
public class PublicationFormValidator implements Validator {
	...
	private FieldValidator<String> precioValdator = new PositiveDoubleValidator("price");
	private FieldValidator<String> coveredValdator = new PositiveDoubleValidator("covered");
	private FieldValidator<String> uncoveredValdator = new PositiveDoubleValidator("uncovered");
	...
	private FieldValidator<String> kitchenValidator = new PositiveIntValidator("kitchen");
	private FieldValidator<String> dinningRoomValidator = new PositiveIntValidator("dinningRoom");
	private FieldValidator<String> roomValidator = new PositiveIntValidator("room");
